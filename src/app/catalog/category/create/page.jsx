...
export default function CreateCategoryPage() {
  ...
  useEffect(() => {
    fetch('/api/catalog/departments?pageSize=100')
      .then(r => r.json())
      .then(json => { if (json.success) setDepartments(json.data.records); })
      .catch(() => {});
  }, []);
  ...
  return (
    <div className="font-sans text-sm">   {/* ← yeh wrapper missing tha */}
